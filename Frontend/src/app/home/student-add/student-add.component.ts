...
export class StudentAddComponent {
  ...
  student: any = {
    ...
    studentCreatedBy: 'Admin', // Added StudentCreatedBy field, default value can be adjusted
  };
  isSaveDisabled = true;
  modalTitle: string = 'Add Student'; // Define modalTitle
  ...
  addStudent() {
    ...
    this.http
      .post('https://localhost:7059/api/Student/AddStudent', this.student)
      .subscribe({
        next: (response) => {
